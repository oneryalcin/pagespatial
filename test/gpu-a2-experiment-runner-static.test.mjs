...
test('A2 launcher requires clean source and exact app cleanup', () => {
...
test('A2 launcher can reuse only a complete current CPU control', () => {
...
test('GPU work starts only after native evidence is precomputed on CPU', () => {
...
test('A2 launcher varies only the predeclared tier and recognition batch grids', () => {
