...
unreconciled reservations plus the next worst case stays at or below USD 40.
...
def load_ledger(path: Path) -> dict[str, Any]:
    ...
    ledger.setdefault("operationalStopUsd", OPERATIONAL_STOP_USD)
