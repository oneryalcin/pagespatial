#!/usr/bin/env python3
"""Launch bounded GPU instrumentation runs and stop their exact Modal apps."""
...
def run_m1(out_dir: Path, pdf_path: Path, native_evidence_path: Path) -> dict:
    revision = require_clean_revision()
